...
@section('content')
    <div class="my-login">
        <form action="{{URL::to('/customer_login')}}" method="post">
            ...
            ?>
            <span>Email</span>
            <input type="email" name="customer_email" class="box" placeholder="Email" required="">
            <span>Mật khẩu</span>
            <input type="password" name="customer_password" class="box" placeholder="Mật khẩu" required="">
            <div class="checkbox">
